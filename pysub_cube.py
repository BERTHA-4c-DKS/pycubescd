...
parser.add_argument("-f1","--file1", help="cube format file to be subtracted", type=str)
parser.add_argument("-f2","--file2", help="cube format file to be subtracted", type=str)
